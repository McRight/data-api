// Options
const CLIENT_ID = '575255145525-avuuiq8ej78f8l6btafsvst1uifkg1im.apps.googleusercontent.com';
...
channelForm.addEventListener('submit', e => {
    ...
    const userChoice = channelChoiceSelect.options[channelChoiceSelect.selectedIndex].value;
...
channelChoiceSelect.addEventListener("change", e => {
    let index = channelChoiceSelect.options[channelChoiceSelect.selectedIndex].value;

    if(index == 1){
        channelInput.placeholder = "googledevelopers"
    } else if(index == 2){
        channelInput.placeholder = "UC_x5XG1OV2P6uZZ5FSM9Ttw";
    }
        ...
        .then(response => {
            ...
            const output = `
                <ul class="collection">
                    ...
                    <li class="collection-item">Custom URL: ${channel.snippet.customUrl}</li>
...
function getChannelUser() {
    gapi.client.youtube.channels
        ...
        .then(response => {
            console.log("User's Channel Response: ", response);
...
function getChannelById(channel) {
    gapi.client.youtube.channels
        ...
        .then(response => {
            console.log("Id Channel Response: ", response);
...
function requestVideoPlayList(playlistId) {
    ...
    request.execute(response => {
        ...
        if(playListItems){
            ...
            // Loop through videos and append them
